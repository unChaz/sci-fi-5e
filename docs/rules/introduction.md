...
### Space Wars
The great factions of humanity are in an indefinite state of cold war, and open battle has not happened in decades. When it has happened, battles in space are fast, short, and leave few survivors. The most ship-to-ship action you might see is pirates or authorities boarding you, which can result in a quick search or seizure, or a gunfight over control the ship.
