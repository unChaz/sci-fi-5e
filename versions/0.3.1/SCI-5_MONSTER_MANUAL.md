<style>
  ...
  .phb#p1 .wide h1 {  color: white;font-size:80px }
...
**Skills** Medicine +7, Charm +3, Religion +4
...
**_Alien Eminence_**. As a bonus action, the priest can expend a tek skill slot to cause its melee weapon attacks to deal an extra 10 (3d6) kinetic damage to a target on a hit. This benefit lasts until the end of the turn. If the priest expends a tek skill slot of 2nd level or higher, the extra damage increases by 1d6 for each level above 1st.
...
Hags are humans who were once scions who when too far in their exploration of tek, and were corrupted and consumed by it.
...
**_Languages_**. The half-dragon speaks Alien in addition to any other languages it knows.
...
Lizardfolk were once humans who were genetically modified to survive the harsh environments of newly colonized worlds.
...
Genetically modified with animal DNA and Tek, lycanthropes are right out of the old storybooks. They can infect you with their tek infused animal DNA.
...
**_pulse axe (Humanoid or Hybrid Form Only)_**. _Melee Weapon Attack:_ +7 to hit, reach 5 ft., one target. _Hit:_ 10 (1d12 + 4) slashing damage.
...
**Damage Resistances** kinetic; bludgeoning, piercing, and slashing from nontek attacks
...
**_Angelic Weapons_**. The deva's weapon attacks are tek. When the deva hits with any weapon, the weapon deals an extra 4d8 kinetic damage (included in the attack).
...
**_Mace_**. _Melee Weapon Attack:_ +8 to hit, reach 5 ft., one target. _Hit:_ 7 (1d6 + 4) bludgeoning damage plus 18 (4d8) kinetic damage.
...
**_Change Shape_**. The deva polymorphs into a alien or beast that has a challenge rating equal to or less than its own, or back into its true form. It reverts to its true form if it dies. Any equipment it is wearing or carrying is absorbed or borne by the new form (the deva's choice).
...
**_Angelic Weapons_**. The planetar's weapon attacks are tek. When the planetar hits with any weapon, the weapon deals an extra 5d8 kinetic damage (included in the attack).
...
**_Greatsword_**. _Melee Weapon Attack:_ +12 to hit, reach 5 ft., one target. _Hit:_ 21 (4d6 + 7) slashing damage plus 22 (5d8) kinetic damage.
...
**_Angelic Weapons_**. The solar's weapon attacks are tek. When the solar hits with any weapon, the weapon deals an extra 6d8 kinetic damage (included in the attack).
...
**_Greatsword_**. _Melee Weapon Attack:_ +15 to hit, reach 5 ft., one target. _Hit:_ 22 (4d6 + 8) slashing damage plus 27 (6d8) kinetic damage.

**_Slaying Recoil Rifle_**. _Ranged Weapon Attack:_ +13 to hit, range 150/600 ft., one target. _Hit:_ 15 (2d8 + 6) piercing damage plus 27 (6d8) kinetic damage. If the target is a creature that has 100 hit points or fewer, it must succeed on a DC 15 Constitution saving throw or die.
...
**_Searing Burst (Costs 2 Actions)_**. The solar emits tek, Alien energy. Each creature of its choice in a 10-foot radius must make a DC 23 Dexterity saving throw, taking 14 (4d6) fire damage plus 14 (4d6) kinetic damage on a failed save, or half as much damage on a successful one.
...
**_Moan_**. Each creature within 60 feet of the cloaker that can hear its moan and that isn't an alien must succeed on a DC 13 Wisdom saving throw or become frightened until the end of the cloaker's next turn. If a creature's saving throw is successful, the creature is immune to the cloaker's moan for the next 24 hours
...
**_Change Shape_**. The couatl polymorphs into a alien or beast that has a challenge rating equal to or less than its own, or back into its true form. It reverts to its true form if it dies. Any equipment it is wearing or carrying is absorbed or borne by the new form (the couatl's choice).
...
_Huge alien (prothean), chaotic evil_
...
_Small alien (prothean), chaotic evil_
...
**Languages** telepathy 60 ft. (works only with creatures that understand Alien)
...
_Large alien (prothean), chaotic evil_
...
_Tiny alien (prothean, shapechanger), chaotic evil_
...
**Languages** Alien, telepathy 120 ft.

**Challenge** 5 (1,800 XP)

**_Barbed Hide_**. At the start of each of its turns, the barbed zabrak deals 5 (1d10) piercing damage to any creature grappling it.

**_Devil's Sight_**. Tek darkness doesn't impede the zabrak's darkvision.

**_Tek Resistance_**. The zabrak has advantage on saving throws against tek skills and other tek effects.

**Actions**

**_Multiattack_**. The zabrak makes three melee attacks: one with its tail and two with its claws. Alternatively, it can use Hurl Flame twice.
...
**_Steadfast_**. The zabrak can't be frightened while it can see an allied creature within 30 feet of it.
...
_Large alien (zabrak), lawful evil_
...
**_Multiattack_**. The zabrak makes three attacks: two with its claws and one with its sting.
...
**_Multiattack_**. The zabrak makes two attacks with its chains.

**_Chain_**. _Melee Weapon Attack:_ +8 to hit, reach 10 ft., one target. _Hit:_ 11 (2d6 + 4) slashing damage. The target is grappled (escape DC 14) if the zabrak isn't already grappling a creature. Until this grapple ends, the target is restrained and takes 7 (2d6) piercing damage at the start of each of its turns.

**_Animate Chains (Recharges after a Short or Long Rest)_**. Up to four chains the zabrak can see within 60 feet of it sprout razor-edged barbs and animate under the zabrak's control, provided that the chains aren't being worn or carried.

Each animated chain is an object with AC 20, 20 hit points, resistance to piercing damage, and immunity to psychic and concussive damage. When the zabrak uses Multiattack on its turn, it can use each animated chain to make one additional chain attack. An animated chain can grapple one creature of its own but can't make attacks while grappling. An animated chain reverts to its inanimate state if reduced to 0 hit points or if the zabrak is incapacitated or dies.

**Reactions**

**_Unnerving Mask_**. When a creature the zabrak can see starts its turn within 30 feet of the zabrak, the zabrak can create the illusion that it looks like one of the creature's departed loved ones or bitter enemies. If the creature can see the zabrak, it must succeed on a DC 14 Wisdom saving throw or be frightened until the end of its turn.
...
**_Multiattack_**. The zabrak makes three melee attacks: two with its fork and one with its tail. It can use Hurl Flame in place of any melee attack.

**_Fork_**. _Melee Weapon Attack:_ +10 to hit, reach 10 ft., one target. _Hit:_ 15 (2d8 + 6) piercing damage.

**_Tail_**. _Melee Weapon Attack:_ +10 to hit, reach 10 ft., one target. _Hit:_ 10 (1d8 + 6) piercing damage. If the target is a creature other than an undead or a construct, it must succeed on a DC 17 Constitution saving throw or lose 10 (3d6) hit points at the start of each of its turns due to an infernal wound. Each time the zabrak hits the wounded target with this attack, the damage dealt by the wound increases by 10 (3d6). Any creature can take an action to stanch the wound with a successful DC 12 Wisdom (Medicine) check. The wound also closes if the target receives tek healing.
...
_Tiny alien (zabrak, shapechanger), lawful evil_
...
**_Multiattack_**. The zabrak makes three attacks: one with its bite, one with its claws, and one with its tail.
...
**_Wall of Ice (Recharge 6)_**. The zabrak forms an opaque wall of ice on a solid surface it can see within 60 feet of it. The wall is 1 foot thick and up to 30 feet long and 10 feet high, or it's a hemispherical dome up to 20 feet in diameter.

When the wall appears, each creature in its space is pushed out of it by the shortest route. The creature chooses which side of the wall to end up on, unless the creature is incapacitated. The creature then makes a DC 17 Dexterity saving throw, taking 35 (10d6) cold damage on a failed save, or half as much damage on a successful one.

The wall lasts for 1 minute or until the zabrak is incapacitated or dies. The wall can be damaged and breached; each 10-foot section has AC 5,
...
**_Fear Aura_**. Any creature hostile to the pit alien that starts its turn within 20 feet of the pit alien must make a DC 21 Wisdom saving throw, unless the pit alien is incapacitated. On a failed save, the creature is frightened until the start of its next turn. If a creature's saving throw is successful, the creature is immune to the pit alien's Fear Aura for the next 24 hours.

**_Tek Resistance_**. The pit alien has advantage on saving throws against tek skills and other tek effects.

**_Tek Weapons_**. The pit alien's weapon attacks are tek.

**_Innate Tekcasting_**. The pit alien's Tekcasting ability is Charisma (tek skill save DC 21). The pit alien can innately cast the following tek skills, requiring no material components:
...
**_Multiattack_**. The pit alien makes four attacks: one with its bite, one with its claw, one with its mace, and one with its tail.
...
_Medium alien (shapechanger), neutral_
...
**_Shapechanger_**. The doppelganger can use its action to polymorph into a Small or Medium alien it has seen, or back into its true form. Its statistics, other than its size, are the same in each form. Any equipment it is wearing or carrying isn't transformed. It reverts to its true form if it dies.
...
_Medium alien (pandoran), neutral_
...
**Languages** Dwarvish, Alien

**Challenge** 1 (200 XP)

**_Dark Traveler Resilience_**. The duergar has advantage on saving throws against poison, tek skills, and illusions, as well as to resist being charmed or paralyzed.
...
_Medium alien (elf), neutral evil_
...
_Medium alien (gnoll), chaotic evil_
...
## Traveler (Svirfneblin)

_Small alien (traveler), neutral good_
...
**Languages** Gnomish, Terran, Alien

**Challenge** 1/2 (100 XP)

**_Stone Camouflage_**. The traveler has advantage on Dexterity (Stealth) checks made to hide in rocky terrain.

**_Gnome Cunning_**. The traveler has advantage on Intelligence, Wisdom, and Charisma saving throws against tek.

**_Innate Tekcasting_**. The traveler's innate Tekcasting ability is Intelligence (tek skill save DC 11). It can innately cast the following tek skills, requiring no material components:
...
**Languages** Common, Green Traveler
...
**_schunterher_**. _Ranged Weapon Attack:_ +4 to hit, range 80/320 ft., one target. _Hit:_ 5 (1d6 + 2) piercing damage.

## Hell Hound

_Medium alien, lawful evil_
...
**Languages** understands Alien but can't speak it
...
_Medium alien (traveler), lawful evil_

**Armor Class** 18 (scarab skin, shield)
...
_Small alien (traveler), lawful evil_
...
**_ion dagger_**. _Melee Weapon Attack:_ +4 to hit, reach 5 ft., one target. _Hit:_ 4 (1d4 + 2) piercing damage.
...
**Languages** understands Common, and Alien but can't speak
...
**_Amorphous_**. The alien (ooze) can move through a space as nbullet as 1 inch wide without squeezing.

**_Corrode Metal_**. Any nontek weapon made of metal that hits the alien (ooze) corrodes. After dealing damage, the weapon takes a permanent and cumulative −1 penalty to damage rolls. If its penalty drops to −5, the weapon is destroyed. Nontek ammunition made of metal that hits the alien (ooze) is destroyed after dealing damage.

The alien (ooze) can eat through 2-inch-thick, nontek metal in 1 round.

**_False Appearance_**. While the alien (ooze) remains motionless, it is indistinguishable from an oily pool or wet rock.
...
_Medium alien (hunter), chaotic evil_
...
**_Aggressive_**. As a bonus action, the hunter can move up to its speed toward a hostile creature that it can see.
...
_Medium alien (sahuagin), lawful evil_
...
**_schunterher_**. _Ranged Weapon Attack:_ +5 to hit, range 80/320 ft., one target. _Hit:_ 6 (1d6 + 3) piercing damage.
...
**_pulse blade_**. _Melee Weapon Attack:_ +2 to hit, reach 5 ft., one target. _Hit:_ 1 slashing damage.

**_schunterher_**. _Ranged Weapon Attack:_ +6 to hit, range 40/160 ft., one target. _Hit:_ 1 piercing damage, and the target must succeed on a DC 10 Constitution saving throw or become poisoned for 1 minute. If its saving throw result is 5 or lower, the poisoned target falls unconscious for the same duration, or until it takes damage or another creature takes an action to shake it awake.

**_Heart Sight_**. The sprite touches a creature and knows the creature's current emotional state. If the target fails a DC 10 Charisma saving throw, the sprite also knows the creature's alignment. Aliens, aliens, and undead automatically fail the saving throw.
...
_Medium alien (shapechanger), neutral evil_
...
**Languages** Common, Alien, telepathy 60 ft.

**Challenge** 4 (1,100 XP)

**_Telepathic Bond_**. The alien ignores the range restriction on its telepathy when communicating with a creature it has charmed. The two don't even need to be on the same plane of existence.

**_Shapechanger_**. The alien can use its action to polymorph into a Small or Medium alien, or back into its true form. Without wings, the alien loses its flying speed. Other than its size and speed, its statistics are the same in each form. Any equipment it is wearing or carrying isn't transformed. It reverts to its true form if it dies.

**Actions**

**_Claw (Fiend Form Only)_**. _Melee Weapon Attack:_ +5 to hit, reach 5 ft., one target. _Hit:_ 6 (1d6 + 3) slashing damage.

**_Charm_**. One alien the alien can see within 30 feet of it must succeed on a DC 15 Wisdom saving throw or be charmed for 1 day. The charmed target obeys the alien's verbal or telepathic commands. If the target suffers any harm or receives a suicidal command, it can repeat the saving throw, ending the effect on a success. If the target successfully saves against the effect, or if the effect on it ends, the target is immune to this alien's Charm for the next 24 hours.

The alien can have only one target charmed at a time. If it charms another, the effect on the previous target ends.

**_Draining Kiss_**. The alien kisses a creature charmed by it or a willing creature. The target must make a DC 15
...
**_Etherealness_**. The alien enters the Ethereal Plane from the Material Plane, or vice versa.
...
**_pulse axe_**. _Melee Weapon Attack:_ +6 to hit, reach 5 ft., one target. _Hit:_ 17 (2d12 + 4) slashing damage.
...
**_Regeneration_**. The vampire regains 20 hit points at the start of its turn if it has at least 1 hit point and isn't in sunlight or running water. If the vampire takes kinetic damage or damage from holy water, this trait doesn't function at the start of the vampire's next turn.
...
_Sunlight Hypersensitivity._ The vampire takes 20 kinetic damage when it starts its turn in sunlight. While in sunlight, it has disadvantage on attack rolls and ability checks.
...
**_Regeneration_**. The vampire regains 10 hit points at the start of its turn if it has at least 1 hit point and isn't in sunlight or running water. If the vampire takes kinetic damage or damage from holy water, this trait doesn't function at the start of the vampire's next turn.
...
**_Undead Fortitude_**. If damage reduces the zombie to 0 hit points, it must make a Constitution saving throw with a DC of 5 + the damage taken, unless the damage is kinetic or from a critical hit. On a success, the zombie drops to 1 hit point instead.
...
If a non-evil alien dies from this attack, a new shadow rises from the corpse 1d4 hours later.
...
**Skills** Perception +6, Charm +5, Stealth +3
...
**Skills** Charm +11, Perception +17, Stealth +8
...
**Skills** Charm +8, Perception +12, Stealth +6
...
**Skills** Insight +10, Perception +17, Charm +16, Stealth +9
...
**Skills** Insight +8, Perception +14, Charm +13, Stealth +8
...
**Skills** Insight +5, Perception +9, Charm +9, Stealth +6
...
**Skills** Perception +3, Stealth +4, Nature +3
...
**_Multiattack_**. The giant makes two pulse axe attacks.

**_pulse axe_**. _Melee Weapon Attack:_ +9 to hit, reach 10 ft., one target. _Hit:_ 25 (3d12 + 6) slashing damage.
...
**Skills** Charm +7, Insight +4, Stealth +3
...
**_Multiattack_**. The lamia makes two attacks: one with its claws and one with its ion dagger or Intoxicating Touch.
...
**Skills** Charm +5, Insight +4, Perception +4, Stealth +5
